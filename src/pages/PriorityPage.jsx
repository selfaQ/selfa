  ...
  return (
    <div className="bg-bg min-h-screen flex flex-col page-enter p-3 gap-3 pb-6">
      ...
      <div className="rounded-xl p-3 flex flex-col gap-1.5"
        ...
        {[
          { label: 'المبلغ',         value: formatIQD(amount),   color: '#3fffa2' },
          { label: 'القسط الشهري',   value: formatIQD(inst),     color: '#3fffa2' },
          { label: 'المدة',          value: `${duration} شهراً / ${duration} عضو` },
          { label: 'رسوم الاشتراك',  value: formatIQD(subFee),   color: '#f5c842' },
        ].map(row => (
      ...
      <button
        ...
        style={{
          background: priority ? '#d4a017' : '#1a2820',
          color:      priority ? '#1a1000' : '#4a7a60',
          boxShadow:  priority ? '0 0 14px rgba(245,200,66,0.25)' : 'none',

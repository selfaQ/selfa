...
function StatusBar() {
  ...
  return (
    <div className="flex justify-between items-center px-1 py-1.5">
      ...
      <div className="w-1.5 h-1.5 rounded-full bg-mint" style={{ boxShadow: '0 0 6px #3fffa2' }} />
    </div>
  );
}
      ...
      <div className="flex-1 overflow-y-auto p-3 pb-24 flex flex-col gap-3">
        ...
        <div>
          <div className="text-[32px] font-bold leading-none"
            style={{ color: '#3fffa2', textShadow: '0 0 18px rgba(63,255,162,0.45)', fontFamily: 'Tajawal' }}>
            سلفة
          </div>
        ...
        {/* بطاقة الترحيب */}
        <div className="rounded-2xl p-4 border" style={{ background: '#1a2820', borderColor: 'rgba(63,255,162,0.12)' }}>
        ...
        {/* بطاقة السلفة الذاتية */}
        <div
          onClick={() => navigate('/self-salfa')}
          className="rounded-xl p-3 flex items-center gap-3 cursor-pointer"
          style={{ border: '1px dashed rgba(63,255,162,0.3)', background: 'rgba(63,255,162,0.04)' }}>
          <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0"
            style={{ background: 'rgba(63,255,162,0.12)', boxShadow: '0 0 8px rgba(63,255,162,0.15)' }}>
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              <path d="M8 2v12M2 8h12" stroke="#3fffa2" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </div>
          <div>
        ...
        <button
          ...
          style={{
            background:  builder.amount ? '#1db874' : '#1a2820',
            color:       builder.amount ? '#fff' : '#4a7a60',
            boxShadow:   builder.amount ? '0 0 14px rgba(29,184,116,0.3)' : 'none',

// شريط التنقل السفلي — 3 تبويبات (الرئيسية / سلفتي / حسابي)
...
export default function BottomNav({ active }) {
  ...
  return (
    <div className="bg-bg2 rounded-2xl border border-[rgba(63,255,162,0.2)] mx-2 mb-2 px-2 py-2.5 flex justify-around">
      {TABS.map((tab) => {
          ...
          >
            ...
            {isActive && (
              <div className="w-1 h-1 rounded-full bg-mint"
                style={{ boxShadow: '0 0 4px #3fffa2' }} />
            )}
          </button>
        );
      })}
